...
interface RegisterBody {
  ...
  /**
   * Idioma do aparelho de quem se cadastra.
   *
   * O app detecta e manda. É o que permite ao SERVIDOR falar a língua certa
   * depois — e-mail e push saem quando o app está fechado, e aí não há
