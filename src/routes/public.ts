...
interface Dados {
  ...
  escreveram: number; presentes: number; portos: string[];
}
  ...
  <div style="max-width:560px;margin:0 auto;padding:28px 18px 40px">
    ...
    <div style="background:#F7F3EA;border-radius:18px;padding:26px 24px">
      ...
      <p style="margin:22px 0 0;font-size:13px;line-height:20px;color:#5A7185;
        ...
        As palavras que este barco carrega ficam com ele. Só quem o recebe pelo
        mar é que lê — nem aqui, nem em lugar nenhum, elas são publicadas.
      </p>
